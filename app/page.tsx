    ...
    <>
      ...
      <main className="w-full overflow-x-hidden">
        ...
        <section className="section-light">
          <div className="mx-auto w-full max-w-[1400px] px-5 pb-24 pt-20 text-center sm:px-6 sm:pb-32 sm:pt-24 md:pb-36 md:pt-28 lg:px-10 lg:pb-44 lg:pt-32">
            <p className="mx-auto max-w-3xl text-xs font-medium leading-5 tracking-wide text-primary sm:text-sm md:text-base">
              BWL-Student · Universität Bayreuth · Prozessanalyse &amp;
              -automatisierung
            </p>

            <h1 className="mx-auto mt-4 max-w-5xl font-serif text-4xl font-semibold leading-tight tracking-tight text-foreground sm:mt-5 sm:text-5xl md:text-6xl lg:text-7xl">
              Hauke Werner
            </h1>

            <p className="mx-auto mt-3 max-w-5xl text-base leading-7 text-muted-foreground sm:text-lg sm:leading-relaxed md:text-xl">
            ...
            <div className="mx-auto mt-8 flex w-full max-w-sm flex-col gap-3 sm:mt-10 sm:max-w-none sm:flex-row sm:flex-wrap sm:items-center sm:justify-center sm:gap-4">
              <a
                href="/cv.pdf"
                download
            ...
            <p className="mx-auto mt-5 max-w-xl text-xs leading-5 text-muted-foreground sm:text-sm">
        ...
        >
          <div className="mx-auto w-full max-w-[1400px] px-5 py-16 sm:px-6 sm:py-20 md:py-24 lg:px-10 lg:py-28 xl:px-20">
            <div className="mx-auto max-w-5xl">
              <div className="grid items-center gap-10 md:grid-cols-[180px_1fr] md:gap-12 lg:grid-cols-[220px_1fr] lg:gap-16">
                {/* Bild */}
                <figure className="mx-auto w-full max-w-[140px] sm:max-w-[150px] md:mx-0 md:max-w-[160px]">
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="mt-6 space-y-5 text-left text-sm leading-7 text-muted-foreground sm:text-base sm:leading-relaxed">
                    <p>
        ...
        >
          <div className="mx-auto w-full max-w-[1400px] px-5 py-16 sm:px-6 sm:py-20 md:py-24 lg:px-10">
            <h2
              id="projekte-heading"
            ...
            <p className="mx-auto mt-4 max-w-2xl px-1 text-center text-sm leading-7 text-muted-foreground sm:text-base sm:leading-relaxed">
          ...
          <div className="mx-auto w-full max-w-[1400px] px-5 py-16 sm:px-6 sm:py-20 md:py-24 lg:px-10">
            <div className="mx-auto max-w-6xl">
              <div className="mx-auto max-w-2xl text-center">
                <p className="text-xs font-medium tracking-wide text-primary sm:text-sm">
              ...
              <ol className="mt-8 grid grid-cols-1 gap-4 sm:mt-10 sm:gap-5 md:grid-cols-2 lg:mt-12">
                {unterstuetzung.map((punkt) => (
                  <li
                    key={punkt.nummer}
                    className="rounded-xl border border-border bg-card/70 p-5 transition-all duration-200 hover:border-primary/25 hover:bg-card sm:p-6 lg:p-7"
                  >
                    <div className="flex items-start justify-between gap-4 sm:gap-6">
                      <div className="min-w-0">
                        <p className="text-[11px] font-medium uppercase tracking-[0.14em] text-primary sm:text-xs sm:tracking-[0.16em]">
                          Arbeitsbereich
                        </p>
                      ...
                      <span
                        className="shrink-0 font-serif text-2xl font-semibold text-primary/40 sm:text-3xl"
                        aria-hidden="true"
                      >
                        {punkt.nummer}
                      </span>
                    ...
                    <p className="mt-4 text-sm leading-6 text-muted-foreground sm:leading-7 lg:text-base">
                      {punkt.text}
                    </p>
        ...
        <section
          ...
          className="section-light scroll-mt-20 border-t border-border/60"
        >
          <div className="mx-auto w-full max-w-[1400px] px-5 py-16 sm:px-6 sm:py-20 lg:px-10">
            <h2
              id="kontakt-heading"
              className="text-center font-serif text-3xl font-semibold tracking-tight text-foreground sm:text-4xl"
            >
            ...
            <div className="mx-auto mt-8 flex w-full max-w-sm flex-col gap-3 sm:max-w-none sm:flex-row sm:items-center sm:justify-center sm:gap-4">
              <a
                href="mailto:hauke.werner@gmx.net"
                className="inline-flex w-full items-center justify-center gap-2 rounded-md border border-border px-5 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-secondary sm:w-auto"
              >
