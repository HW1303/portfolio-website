...
export function SiteFooter() {
  return (
    <footer className="mt-16 border-t border-primary/80 bg-primary sm:mt-20 lg:mt-24 2xl:mt-28">
      <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-5 px-5 py-7 text-sm text-primary-foreground/80 sm:px-6 sm:py-8 md:flex-row md:items-center md:justify-between lg:px-10 2xl:max-w-[1600px] 2xl:px-12 2xl:py-10 2xl:text-base">
